...
const post=()=>{
  ...
  return (
    <div className='flex justify-center items-center h-[100vh] h-screen bg-[#8da29c]' >
...
<svg
  ...
  <input type="password" value={pass} onChange={(e)=>(setPass(e.target.value))} className="grow" placeholder="Password" />
    ...
    <div className="card-actions">
      <button onClick={post} className="btn bg-[#8c9390] text-white">Sign up</button>
    </div>
  </div>
<div>
    </div>
    ...
    <img  className='w-[80%]' src="https://cdn-icons-png.flaticon.com/512/3429/3429149.png" alt="" />
